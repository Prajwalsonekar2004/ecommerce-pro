...
export default function ProductForm({
  ...
  const [form, setForm] = useState<ProductFormValues>({
    ...defaultValues,
    ...initialValues,
    selectedSizes: initialValues?.selectedSizes ?? [],
  });
  ...
  function toggleSize(size: SizeValue) {
    setForm((current) => ({
      ...current,
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (isLoadingCatalog || isSubmitting) {
      return;
    }
    ...
    const payload = {
      ...
      newArrival: form.isNewArrival,
      trending: form.isTrending,
      ...
      sizes: form.selectedSizes.map((size) => ({
        size,
        quantity: 0,
      })),
    };
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-8 sm:px-8 lg:px-12">
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-sm text-neutral-500">{pageDescription}</p>
          </div>
        </div>
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-5 sm:p-7">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Toggle
                ...
                onChange={(value) => updateField("isNewArrival", value)}
              />
            ...
            <div className="mt-4 max-w-sm">
              <Toggle
                ...
                onChange={(value) => updateField("isOnSale", value)}
              />
            </div>
          </section>
